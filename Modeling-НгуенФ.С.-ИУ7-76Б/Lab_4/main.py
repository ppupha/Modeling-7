...
class MainWindow(QWidget):
    ...
    def _parse_parameters(self):
        try:
            ...
            mu = float(ui.lineEdit_servicemachine_lambda.text())
            sigma = float(ui.lineEdit_servicemachine_k.text())
            ...
            model = modeller.Modeller(uniform_a, uniform_b, mu, sigma, reenter)
            if method == 0:
